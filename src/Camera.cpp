...
{
    rotationAnimator->AddKeyframe(0, glm::vec4(1.0f, 0.0f, 0.0f,glm::pi<float>()), Animator::HOLD);
    rotationAnimator->AddKeyframe(1800, glm::vec4(1.0f, 0.0f, 0.0f, glm::pi<float>()), Animator::EASE_IN_OUT);
}
void Camera::setupPositionAnimation(Animator* positionAnimator)
{
    positionAnimator->AddKeyframe(0, glm::vec4(0.0f, 10.0f, 10.0f, 0.0f), Animator::HOLD);
    positionAnimator->AddKeyframe(1800, glm::vec4(0.0f, 10.0f, 30.0f, 0.0f), Animator::HOLD);
}