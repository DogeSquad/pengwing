...
void Camera::setupRotationAnimation(Animator* rotationAnimator)
{
    ...
    rotationAnimator->AddKeyframe(1400, glm::vec4(1.0f, 0.0f, 0.0f, -0.04f * glm::half_pi<float>()), Animator::HOLD);

    rotationAnimator->AddKeyframe(2040, glm::vec4(0.0f, 1.0f, 0.0f, glm::pi<float>() + 0.4f), Animator::HOLD);
}
void Camera::setupPositionAnimation(Animator* positionAnimator)
{
    ...
    positionAnimator->AddKeyframe(1400, glm::vec4(-250.0f, 84.0f, 20.0f, 1.0f), Animator::HOLD);
    positionAnimator->AddKeyframe(1500, glm::vec4(-275.0f, 84.0f, 20.0f, 1.0f), Animator::EASE_IN);
    positionAnimator->AddKeyframe(1750, glm::vec4(-375.0f, 84.0f, 20.0f, 1.0f), Animator::LINEAR);
    positionAnimator->AddKeyframe(1800, glm::vec4(-410.0f, 84.0f, 20.0f, 1.0f), Animator::EASE_OUT);
    positionAnimator->AddKeyframe(1830, glm::vec4(-410.0f, 84.0f, 20.0f, 1.0f), Animator::HOLD);
    positionAnimator->AddKeyframe(1860, glm::vec4(-410.8f, 84.8f, 20.8f, 1.0f), Animator::EASE_OUT_SHAKE);
    positionAnimator->AddKeyframe(1862, glm::vec4(-410.0f, 84.0f, 20.0f, 1.0f), Animator::LINEAR);

    positionAnimator->AddKeyframe(2040, glm::vec4(-4.0f, 9.0f, 15.0f, 1.0f), Animator::HOLD);
}