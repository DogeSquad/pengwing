...
{
    positionAnimator->AddKeyframe(480, glm::vec4(0.0f, 5.0f, 10.0f, 0.0f), Animator::HOLD);
    positionAnimator->AddKeyframe(1000, glm::vec4(0.0f, 10.0f, 30.0f, 0.0f), Animator::EASE_IN_OUT);
